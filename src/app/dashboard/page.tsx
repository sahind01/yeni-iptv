        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="mb-3">
          {!showForm ? (
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="p-5 rounded-xl border border-gray-700 bg-[#1a1a1a]">
              ...
              {formSent ? (
                <div className="text-center py-6"><FiCheck className="w-10 h-10 text-green-400 mx-auto mb-2" /><p className="text-sm text-green-400 font-medium">Gönderildi!</p><p className="text-[11px] text-gray-400 mt-1">Teşekkürler</p></div>
              ) : (
